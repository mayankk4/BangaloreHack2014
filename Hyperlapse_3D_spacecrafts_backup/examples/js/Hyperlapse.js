  ...
  _renderer = isWebGL() ? new THREE.WebGLRenderer() : new THREE.CanvasRenderer();
	...
	var render = function() {
		if(!_is_loading && self.length()>0) {
			...
			// var _stereoEffect = new THREE.StereoEffect(_renderer);
			// _stereoEffect.setSize(_w, _h);
			// _stereoEffect.separation = 10;
			// _stereoEffect.render( _scene, _camera );
			// self.stereoEffect = _stereoEffect;
